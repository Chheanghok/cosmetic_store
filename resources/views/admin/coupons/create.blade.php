                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('coupons.store') }}">
                        ...
                        <div>
                            ...
                            <input id="code" name="code" type="text" class="block mt-1 w-full" value="{{ old('code') }}" required>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input id="value" name="value" type="number" step="0.01" class="block mt-1 w-full" value="{{ old('value') }}" required>
                        </div>
